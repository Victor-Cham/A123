...
window.categorias = [
  ...
  },
  {
    ...
    catalogos: [
      ...
      "Actos contra el Pudor;Lesiones Leves por Violencia Familiar",
      ...
      "Conducción en estado de ebriedad;Falsedad Ideológica",
      "Conducir en Estado de Ebriedad;Homicidio Calificado",
      "Conducción en estado de ebriedad;Hurto Simple;Violación Sexual",
      "Conducción en estado de ebriedad;Lesiones Leves por Violencia Familiar",
      "Conducción en estado de ebriedad;Violación Sexual de menor de edad",
      "Conducción de Vehículo en Estado de Ebriedad;Falsificación de Documentos",
      ...
      "Delitos Informático - Acceso Ilícito",
      "Delitos Monetarios",
      ...
      "Disturbios",
      "Estafa",
      "Estafa;Lesiones Leves por Violencia Familiar",
      "Estafa Agravada",
      ...
      "Falsedad Ideológica",
      "Falsedad Ideológica;Actos contra el Pudor",
      "Falsedad Ideológica; Lesiones Leves por Violencia Familiar",
      "Falsedad Ideológica; Organización Criminal; Estafa Agravada",
      "Falsificación de Documentos",
      "Falsificación de Documentos;Apropiación Ilícita",
      "Falsificación de Documentos;Falsedad Ideológica;Falsedad Genérica",
      ...
      "Hurto Agravado;Lesiones Leves por Violencia Familiar",
      "Hurto Agravado;Receptación;Estafa",
      "Hurto Simple",
      "Hurto Simple;Lesiones Leves por Violencia Familiar",
      ...
      "Lesiones Culposas;Conducción en estado de ebriedad",
      ...
      "Lesiones Culposas;Violación Sexual",
      "Lesiones Dolosas",
      "Lesiones Graves",
      "Lesiones Graves;Conducción en estado de ebriedad",
      "Lesiones Graves;Estafa;Apropiación Ilícita",
      ...
      "Lesiones Leves;Lesiones Culposas;Estafa",
      "Lesiones Leves;Usurpación Agravada",
      "Lesiones Leves por Violencia Familiar",
      "Lesiones Leves por Violencia Familiar;Abigeo",
      ...
      "Omisión Asistencia Familiar;Homicidio",
      "Omisión Asistencia Familiar;Faltas contra las Personas",
      "Omisión Asistencia Familiar;Hurto Agravado",
      "Omisión de Asistencia Familiar",
      "Omisión de Asistencia Familiar;Lesiones Leves",
      "Omisión de Asistencia Familiar;Violación de la Intimidad",
      ...
      "Robo Agravado;Terrorismo;Lesiones Leves;Tráfico Ilícito de Drogas",
      "Secuestro",
      "Seducción",
      "Suplantación EMO",
      ...
      "Tocamientos de connotación sexual sin consentimiento en agravio de menor de edad",
      ...
      "Usurpación;Omisión de Asistencia Familiar",
      ...
      "Violación Sexual",
      "Violación Sexual;Lesiones Leves por Violencia Familiar",
      "Violación Sexual;Omisión de Asistencia Familiar",
      "Violación Sexual;Omisión de Asistencia Familiar;Lesiones Leves por Violencia Familiar",
